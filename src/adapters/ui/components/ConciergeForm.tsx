...
export default function ConciergeForm() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    console.log({ schedule, events, contact });
  };
  ...
  return (
    <div className="max-w-md m-2 bg-brand-50 p-5 shadow-md">
      <form onSubmit={handleSubmit}>
        <h2 className="text-brand-50 dark:text-brand-200 text-2xl mb-6 text-center font-bold">Concierge Service Information</h2>
